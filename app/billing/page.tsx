...
import { PLAN_CONFIGS, getBillingLabel, getPlanConfig, normalizePlan, type BillingCycle, type SubscriptionPlan } from '@/lib/subscription';
...
export default function BillingPage() {
  ...
  const [selectedPlan, setSelectedPlan] = useState<SubscriptionPlan>(normalizePlan(searchParams.get('plan')));
